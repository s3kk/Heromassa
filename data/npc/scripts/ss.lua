...
shopModule:addBuyableItem({'instense healing'}, 2265, 95, 2, 'intense healing rune')
...
shopModule:addBuyableItem({'light magic missile'}, 2287, 40, 15, 'light magic missile rune')
shopModule:addBuyableItem({'heavy magic missile'}, 2311, 120, 15, 'heavy magic missile rune')
shopModule:addBuyableItem({'great fireball'}, 2304, 180, 5, 'great fireball rune')
...
shopModule:addBuyableItem({'convince creature'}, 2290, 80, 5, 'convince creature rune')
shopModule:addBuyableItem({'chameleon'}, 2291, 210, 5, 'chameleon rune')
shopModule:addBuyableItem({'desintegrate'}, 2310, 80,  5, 'desintegreate rune')
