...
shopModule:addBuyableItem({'ultimate healing'}, 2273, 175, 5, 'ultimate healing rune')
shopModule:addBuyableItem({'magic wall'}, 2293, 350, 10, 'magic wall rune')
shopModule:addBuyableItem({'destroy field'}, 2261, 45, 10, 'destroy field rune')
...
shopModule:addBuyableItem({'great fireball'}, 2304, 180, 20, 'great fireball rune')
shopModule:addBuyableItem({'explosion'}, 2313, 250, 13, 'explosion rune')
shopModule:addBuyableItem({'sudden death'}, 2268, 350, 11, 'sudden death rune')
shopModule:addBuyableItem({'Heavy Holy Missile'}, 2295, 200, 20, 'Heavy Holy Missile')
shopModule:addBuyableItem({'paralyze'}, 2278, 700, 4, 'paralyze rune')
...
shopModule:addBuyableItemContainer({'bp sd'}, 2003, 2268, 7000, 11, 'backpack of sudden death')
shopModule:addBuyableItemContainer({'bp uh'}, 2002, 2273, 3500, 5, 'backpack of ultimate healing')
