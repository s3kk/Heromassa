...
shopModule:addBuyableItem({'mana rune'}, 2309, 200, 100, 'mana rune')
shopModule:addBuyableItem({'health potion'}, 7618, 45, 100, 'health potion')
shopModule:addBuyableItem({'mana potion'}, 7620, 50, 100, 'mana potion')
shopModule:addBuyableItem({'strong health'}, 7588, 100, 100, 'strong health potion')
shopModule:addBuyableItem({'strong mana'}, 7589, 80, 100, 'strong mana potion')
shopModule:addBuyableItem({'great health'}, 7591, 190, 100, 'great health potion')
shopModule:addBuyableItem({'great mana'}, 7590, 120, 100, 'great mana potion')
shopModule:addBuyableItem({'great spirit'}, 8472, 190, 100, 'great spirit potion')
shopModule:addBuyableItem({'ultimate health'}, 8473, 310, 100, 'ultimate health potion')
shopModule:addBuyableItem({'antidote potion'}, 8474, 50, 100, 'antidote potion')
