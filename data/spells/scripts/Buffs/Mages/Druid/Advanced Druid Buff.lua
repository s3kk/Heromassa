...
setConditionParam(condition3, CONDITION_PARAM_STAT_MAXHEALTHPERCENT, 105)
...
setConditionParam(condition4, CONDITION_PARAM_SKILL_SHIELDPERCENT, 175)
...
setConditionParam(condition5, CONDITION_PARAM_HEALTHGAIN, 75)
