...
setConditionParam(condition2, CONDITION_PARAM_MANAGAIN, 25)
...
setConditionParam(condition3, CONDITION_PARAM_STAT_MAXMANAPERCENT, 115)
...
setConditionParam(condition4, CONDITION_PARAM_STAT_MAGICPOINTS, 12)
...
setConditionParam(condition5, CONDITION_PARAM_SKILL_SHIELDPERCENT, 120)
...
setConditionParam(condition6, CONDITION_PARAM_LIGHT_LEVEL, 8)
