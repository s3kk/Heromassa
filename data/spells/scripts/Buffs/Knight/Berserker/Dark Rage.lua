...
setConditionParam(condition1, CONDITION_PARAM_SUBID, 4)
...
setConditionParam(condition2, CONDITION_PARAM_SUBID, 4)
setConditionParam(condition2, CONDITION_PARAM_TICKS, 5 * 60 * 1000)
setConditionParam(condition2, CONDITION_PARAM_SOULGAIN, -1)
setConditionParam(condition2, CONDITION_PARAM_SOULTICKS, 2000)
