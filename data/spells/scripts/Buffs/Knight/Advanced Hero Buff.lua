...
setConditionParam(condition2, CONDITION_PARAM_SKILL_MELEE, 13)
setConditionParam(condition2, CONDITION_PARAM_SKILL_SHIELD, 25)
setConditionParam(condition2, CONDITION_PARAM_STAT_MAXHEALTHPERCENT, 120)
...
setConditionParam(condition3, CONDITION_PARAM_LIGHT_LEVEL, 8)
...
setConditionParam(condition4, CONDITION_PARAM_HEALTHGAIN, 175)
setConditionParam(condition4, CONDITION_PARAM_HEALTHTICKS, 8000)
