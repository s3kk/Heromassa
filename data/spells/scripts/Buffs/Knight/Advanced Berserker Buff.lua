...
setConditionParam(condition2, CONDITION_PARAM_SKILL_MELEE, 25)
setConditionParam(condition2, CONDITION_PARAM_SKILL_SHIELD, 13)
setConditionParam(condition2, CONDITION_PARAM_STAT_MAXHEALTHPERCENT, 115)
