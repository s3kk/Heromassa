...
setConditionFormula(condition1, 0.35, 0, 0.35, 0)
...
setConditionParam(condition2, CONDITION_PARAM_SKILL_DISTANCE, 22)
...
setConditionParam(condition3, CONDITION_PARAM_STAT_MAXHEALTHPERCENT, 115)
...
setConditionParam(condition4, CONDITION_PARAM_MANAGAIN, 17)
setConditionParam(condition4, CONDITION_PARAM_MANATICKS, 2000)
setConditionParam(condition4, CONDITION_PARAM_HEALTHGAIN, 17)
...
setConditionParam(condition5, CONDITION_PARAM_LIGHT_LEVEL, 8)
