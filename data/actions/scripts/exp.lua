...
local texto = 'Double Experience Por Usar a Potion...Duração 30 Minutos Aproveite.' -- Texto que irá receber ao usar a potion.
textofinal = 'Double exp finalizado.' -- Texto que irá receber quando o efeito da potion acabar.
